...
#creates tab-delimited text file with genes and p-values side by side, utilized in onset-stratified alzheimers project to quickly create annotations of all-group variants
#useful for maf stratified analyses
import pandas
 
L = []

 #file in this would be the 05 file
file = pandas.read_table("05/all.SkatO.assoc")
f = open("final.txt", "a+")
f.write("Gene Name")
for x in file['Gene']:
    L.append(x)    
...
file05 = pandas.read_table("05/all.SkatO.assoc")
f05 = open("05.txt", "a+")
...
file01 = pandas.read_table("01/all.SkatO.assoc")
f01 = open("01.txt", "a+")
#this is where i make a new file with just one column of p-values, if there is a p value it will show up in this file and if there isn't it'll just show up as NA
...
#file in this would be the 001 file
file001 = pandas.read_table("001/all.SkatO.assoc")
f001 = open("001.txt", "a+")
#this is where i make a new file with just one column of p-values, if there is a p value it will show up in this file and if there isn't it'll just show up as NA
...
file0001 = pandas.read_table("0001/all.SkatO.assoc")
...
fileSingletons = pandas.read_table("singletons/all.SkatO.assoc")
