...
file = pandas.read_table("05/group2.SkatO.assoc")
f = open("final.txt", "a+")
f.write("Gene Name")
for x in file['Gene']:
    L.append(x)    
...
file05 = pandas.read_table("05/group2.SkatO.assoc")
f05 = open("05.txt", "a+")
...
file01 = pandas.read_table("01/group2.SkatO.assoc")
f01 = open("01.txt", "a+")
#this is where i make a new file with just one column of p-values, if there is a p value it will show up in this file and if there isn't it'll just show up as NA
...
#file in this would be the 001 file
file001 = pandas.read_table("001/group2.SkatO.assoc")
f001 = open("001.txt", "a+")
#this is where i make a new file with just one column of p-values, if there is a p value it will show up in this file and if there isn't it'll just show up as NA
...
file0001 = pandas.read_table("0001/group2.SkatO.assoc")
...
fileSingletons = pandas.read_table("singletons/group2.SkatO.assoc")
